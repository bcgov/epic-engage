...
def upgrade():
    ...
    op.execute(sa.text('UPDATE generated_document_template SET hash_code = null where id = 1'))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute(sa.text('DELETE FROM document_type WHERE id = 3'))
    op.execute(sa.text('DELETE FROM document_template WHERE id = 3'))
    # ### end Alembic commands ###
