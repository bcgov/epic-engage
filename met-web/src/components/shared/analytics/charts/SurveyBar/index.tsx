...
import { MetHeader1, MetPaper, MetParagraph, MetLabel, PrimaryButton, MetToggleButton } from 'components/shared/common';
...
import { dashboardCustomStyles } from '../SubmissionTrend';
